  ...
  return (
    <div className="group relative w-[300px] h-[350px] bg-[#111] rounded-xl overflow-hidden border border-white/10">
      ...
      <div className="relative z-10 p-6 h-full flex flex-col justify-end">
        <h3 className="text-2xl font-bold text-white mb-2 translate-y-4 group-hover:translate-y-0 transition-transform duration-150">
          Pixel Card
        </h3>
        <p className="text-white/60 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-150 delay-75">
    ...
    <div className="w-full h-[300px] bg-black flex items-center justify-center overflow-hidden relative">
      <div className="grid grid-cols-10 gap-4">
        {Array.from({ length: 50 }).map((_, i) => (
          <div key={i} className="w-1 h-8 bg-violet-500/50 rounded-full transform hover:rotate-45 transition-transform duration-150" />
        ))}
      </div>
...
const TrueFocus = () => {
  ...
  return (
    <div className="relative w-full max-w-md mx-auto">
      {isFocused && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-40 transition-all duration-200" />
      )}
  ...
  return (
    <div className="group relative w-[300px] h-[400px] bg-[#0a0a0a] rounded-xl border border-white/10 overflow-hidden">
      ...
      <div className="p-8 relative z-10">
        <h3 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40 group-hover:blur-[2px] transition-all duration-200">
          Decay
        </h3>
      </div>
...
const VariableFont = () => {
  return (
    <div className="flex items-center justify-center h-[200px]">
      <h1 
        className="text-6xl text-white cursor-default transition-all duration-200 hover:font-[900] hover:tracking-widest"
