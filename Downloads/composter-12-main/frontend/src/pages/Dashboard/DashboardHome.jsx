              ...
              <Card key={i} hoverEffect className="group">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-white font-medium group-hover:text-violet-400 transition-colors duration-200">{comp.name}</h4>
        ...
        <div>
          ...
          <Card className="h-auto">
            <div className="space-y-3">
              <button className="w-full py-3 px-4 rounded-xl bg-white/5 hover:bg-white/10 text-white text-sm font-medium transition-colors duration-200 text-left flex items-center gap-3">
