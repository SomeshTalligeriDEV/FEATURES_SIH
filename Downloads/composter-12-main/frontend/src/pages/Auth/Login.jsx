...
const Login = () => {
    ...
    return (
        <div className="w-screen h-screen font-[font] relative flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(124,58,237,0.2)_0%,transparent_70%)] pointer-events-none" />
            <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] bg-[radial-gradient(circle,rgba(192,38,211,0.1)_0%,transparent_70%)] pointer-events-none" />
