    ...
    return (
        <div className="max-w-4xl mx-auto h-[calc(100vh-8rem)]">
            ...
            >
                ...
                {/* Neon Glow Effect */}
                <div className="absolute -inset-1 bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 blur-2xl -z-10 opacity-50 group-hover:opacity-75 transition-opacity duration-200" />
            </GlassSurface>
        </div>
    );
};
